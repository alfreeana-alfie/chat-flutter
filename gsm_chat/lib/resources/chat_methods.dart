...
class ChatMethods {
  ...
  Future<void> addMerchantMessageToDb(
      Message message, User sender, Merchant receiver) async {
    var map = message.toMap();
  ...
  Stream<QuerySnapshot> fetchContacts({String userId}) => _userCollection
      .document(userId)
      .collection(CONTACTS_COLLECTION).snapshots();

  Stream<QuerySnapshot> fetchMerchantContacts({String userId}) => _merchantCollection
      .document(userId)
      .collection(CONTACTS_COLLECTION).snapshots();
