...
import 'package:gsm_chat/resources/storage_methods.dart';
...
class ChatMerchantScreen extends StatefulWidget {
  final User receiver;

  ChatMerchantScreen({this.receiver});

  @override
  _ChatMerchantScreenState createState() => _ChatMerchantScreenState();
}

class _ChatMerchantScreenState extends State<ChatMerchantScreen> {
